    ...
    <header className="border-b border-[--color-line] bg-[--color-cream]/80 backdrop-blur supports-[backdrop-filter]:bg-[--color-cream]/60 sticky top-0 z-40">
      <div className="container-editorial flex h-16 items-center justify-between">
        ...
        <nav className="flex items-center gap-6 text-sm font-medium text-[--color-navy-600]" aria-label="Primary navigation">
          ...
          <Link href="/guides" className="hidden sm:inline hover:text-[--color-brand]">Guides</Link>
          <Link href="/#lab" className="hidden md:inline hover:text-[--color-brand]">AI Lab</Link>
          <Link href="/playground" className="hidden md:inline hover:text-[--color-brand]">AI helper</Link>
