...
const SLUG = "build-client-quote-calculator-with-ai";
const TITLE = "Build a Client Quote Calculator With AI";
const SUBJECT = "Build a Client Quote Calculator With AI—No Coding Required";
const PREVIEW = "Turn your pricing rules into a useful interactive tool clients can actually use.";
const HTML_PATH = "automation/approved/2026-09-07-build-client-quote-calculator-with-ai.html";
...
async function waitForConfirmed(apiKey, publicationId, postId) {
  for (let attempt = 1; attempt <= 18; attempt += 1) {
    ...
    if (post?.status === "confirmed") return post;
